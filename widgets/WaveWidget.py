...
class WaveWidget():
    ...
    def draw_canvas(self, wave_length, pulse_length):
        # main wave shape
        self.canvas.create_line(0, 250, 100, 250, 100, 100, 110, 100, 110, 250, 300, 250, 300, 100, 310, 100, 310, 250, 500, 250)
        # wavelength
        ...
        # pulselength
        self.canvas.create_line(100, 70, 110, 70)
        self.canvas.create_line(100, 80, 100, 60)
        self.canvas.create_line(110, 80, 110, 60)
        self.canvas.create_text(130, 50, text='Pulselength = {}'.format(pulse_length))
